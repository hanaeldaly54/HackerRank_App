...
void showCreatePollBottomSheet(BuildContext context,
    ...
    required Postswsprovider postProvider}) {
...
class AddPostBottomSheet extends StatefulWidget {
  ...
  final Postswsprovider postProvider;
...
class CustomwsCard extends StatefulWidget {
  final bool isAdmin;
  final int index;
  final Map<String, dynamic> post;
  ...
  @override
  State<CustomwsCard> createState() => _CustomCardState();
}

class _CustomCardState extends State<CustomwsCard> {
  @override
  Widget build(BuildContext context) {
    return Padding(
