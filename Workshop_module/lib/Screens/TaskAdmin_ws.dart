...
import 'package:workshop/models/Taskmodel.dart';
import 'package:workshop/widgets/tasksubmission.dart';

class TaskAdminWsScreen extends StatelessWidget {
  const TaskAdminWsScreen({super.key});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer<TaskWsprovider>(
...
class AddTaskState extends State<AddTask> {
  ...
  void _addTask(BuildContext context) {
    final provider = Provider.of<TaskWsprovider>(context, listen: false);
    final newTask = Task(
      name: taskName,
...
class _TaskBottomSheetState extends State<TaskBottomSheet> {
  ...
  void _updateTask(BuildContext context) {
    ...
    Provider.of<TaskWsprovider>(context, listen: false)
        .updateTask(widget.index, updatedTask);
    Navigator.pop(context);
  }

  void _deleteTask(BuildContext context) {
    Provider.of<TaskWsprovider>(context, listen: false).deleteTask(widget.index);
