...
import 'package:it_module/widgets/Taskwidgets/submission.dart';
...
class AddTaskState extends State<AddTask> {
  ...
  Future<void> selectDate(BuildContext context) async {
    ...
    if (pickedDate != null && pickedDate != dueDate) {
      setState(() {
        dueDate = pickedDate; // Use '=' instead of '=='
      });
    }
  }
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                initialValue: _Degree.toString(),
                keyboardType: TextInputType.number,
                onChanged: (value) {
                  setState(() {
                    _Degree = int.tryParse(value) ?? 0;
                  });
                },
                decoration: InputDecoration(
                    hintText: 'Degree',
