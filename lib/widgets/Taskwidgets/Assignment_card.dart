...
import 'package:it_module/widgets/Taskwidgets/detailsbottomsheet.dart';

import 'package:open_file/open_file.dart';
import 'package:path_provider/path_provider.dart'; // To get the correct file path
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(widget.dueDate),
                if (isSubmitted) Chip(label: Text('Submitted')),
                if (daysLeft.isNotEmpty && !isSubmitted)
                  Text(daysLeft, style: TextStyle(color: Colors.red)),
              ],
            ),
            const SizedBox(height: 8),
            Row(
