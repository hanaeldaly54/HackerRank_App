...
import 'package:it_module/models/taskmodel/taskdata.dart';
...
class TaskProvider with ChangeNotifier {
      ...
      (index) => Task(
        ...
        submissions: List.generate(
          ...
          (subIndex) => MemberSubmission(
            ...
            comments: 'Comments for submission ${subIndex + 1}',
            degree: subIndex * 5,
  ...
  void addSubmission(int taskIndex, MemberSubmission submission) {
    _tasks[taskIndex].submissions.add(submission);
    notifyListeners();
  }
  ...
  void updateSubmission(int taskIndex, int submissionIndex, MemberSubmission updatedSubmission) {
    _tasks[taskIndex].submissions[submissionIndex] = updatedSubmission;
    notifyListeners();
  }
