...
class ProviderService extends ChangeNotifier {
  ...
  void deletepollrequestApproval(
      BuildContext context, ProviderService pollProvider, String pollId) {
    pendingPolls.add({
      'type': 'delete',
      'pollId': pollId,
    });
  ...
  void editpollrequestApproval(BuildContext context, ProviderService pollProvider,
  ...
  void addpollrequestApproval(BuildContext context, ProviderService pollProvider,
